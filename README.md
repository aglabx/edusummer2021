...
4) **Базовый питон и линукс**, трек для подготовки к основному треку (предположительный старт **21го июня 2021**).
5) **Введение в генетику**, подготовка к экзамену по генетике в аспирантуру (предположительный старт **21го июня 2021**).
